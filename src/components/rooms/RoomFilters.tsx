...
const RoomFilters: React.FC<RoomFiltersProps> = ({ onFilterChange }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-4 mb-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2 place-items-start">
        <div>
          ...
          <select
            ...
            className="w-40 h-[38px] px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500"
          >
